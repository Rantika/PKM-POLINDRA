...
@section('title') Master Data - Skema PKM @endsection
                        ...
                        <table class="table table-striped datatable">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{$data->file ? asset($data->file) : '#'}}" target="{{$data->file ? '_blank' : '_self'}}" class="btn btn-sm btn-{{$data->file ? 'primary' : 'warning'}}" title="{{$data->file ? "Download" : 'Template belum diupload'}}"><i class="bi bi-download"></i></a>
                                </td>
                                <td class="text-center">
    ...
    <div class="modal fade" id="modalDialogScrollable" tabindex="-1">
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                <form action="{{route('meta.scheme.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Tambah Skema PKM</h5>
                    ...
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="text" name="short" class="form-control" placeholder="Singkatan">
                                    <label for="floatingSingkatan">Singkatan</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="condition" style="height: 100px" placeholder="Syarat"></textarea>
                                    <label for="floatingSyarat">Syarat</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div>
                                    <input type="file" name="file" class="form-control" placeholder="Foto">
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered">
            <div class="modal-content">
                <form id="form-update" action="#" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="modal-header">
                        <h5 class="modal-title">Edit Skema PKM</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-floating">
                                    <input type="text" name="short" class="form-control" id="short" placeholder="Singkatan">
                                    <label for="floatingSingkatan">Singkatan</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="description" style="height: 100px" id="description" placeholder="Deskripsi"></textarea>
                                    <label for="floatingDeskripsi">Deskripsi</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-floating">
                                    <textarea class="form-control" name="condition" style="height: 100px" id="condition" placeholder="Syarat"></textarea>
                                    <label for="floatingSyarat">Syarat</label>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div>
                                    <input type="file" name="file" class="form-control" id="file" placeholder="Foto">
                                    <label>Max Size : 5MB</label>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.edit').click(function () {
                ...
                $.ajax({
                    url: `{{route('meta.scheme.show')}}/${id}`,
                    success: function (response) {
                        $('#form-update').attr('action', `{{route('meta.scheme.update')}}/${response.id}`)
            ...
            $(document).on('click', '.delete', function () {
                ...
                swal({
                    ...
                    if (isConfirm) {
                        window.location.replace('{{route('meta.scheme.delete', '')}}/'+id);
                    } else {
